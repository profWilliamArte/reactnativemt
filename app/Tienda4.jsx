...
import { Text, View, FlatList, StyleSheet, Pressable, TextInput, Alert, Modal, ScrollView } from "react-native";
    ...
    return (
        <View style={[styles.container, { backgroundColor: Colors.dark.background }]}>
            <View style={styles.searchContainer}>
                ...
                />
                <Pressable style={styles.searchButton} onPress={manejodeBusqueda}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <Pressable onPress={() => filtrarPorCategorias(item)}>
            ...
            <View style={styles.header}>
                ...
                <Pressable onPress={() => setModalVisible(true)} style={styles.cartInfo}>
                                ...
                                cart.map((item) => (
                                    <View key={item.id} style={styles.cartItem}>
                                        ...
                                        <View style={styles.actionContainer}>
                                            <Pressable onPress={() => cambiarCantidad(item.id, -1)}>
                    ...
                    <View style={styles.productContainer}>
                        ...
                        <View style={styles.quantityContainer}>
                            ...
                            {cart.some(cartItem => cartItem.id === item.id) && cantidades[item.id] > 0 && (
                                <Pressable onPress={() => eliminarProductoDelCarrito(item.id)}>
